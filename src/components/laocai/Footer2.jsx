        ...
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                <Link to="/laocai" className="fab fa-facebook-f"></Link>
                <Link to="/laocai" className="fab fa-twitter"></Link>
                <Link to="/laocai" className="fab fa-instagram"></Link>
                <Link to="/laocai" className="fab fa-linkedin"></Link>
              </div>
            </div>
            <div className="box">
              ...
              <Link to="/laocai#about" className="links">
                <i className="fas fa-arrow-right"></i> About
              </Link>
              <Link to="/laocai#destination" className="links">
                <i className="fas fa-arrow-right"></i> Điểm đến
              </Link>
              <Link to="/laocai#services" className="links">
                <i className="fas fa-arrow-right"></i> Dịch vụ
              </Link>
              <Link to="/laocai#gallery" className="links">
                <i className="fas fa-arrow-right"></i> Ảnh
              </Link>
              <Link to="/laocai#blogs" className="links">
