      ...
      <section className="footer">
        <div className="box-container">
          <div className="box">
            ...
            <div className="share">
              <Link to="/paris" className="fab fa-facebook-f"></Link>
              <Link to="/paris" className="fab fa-twitter"></Link>
              <Link to="/paris"className="fab fa-instagram"></Link>
              <Link to="/paris" className="fab fa-linkedin"></Link>
            </div>
          </div>
          <div className="box">
            ...
            <Link to="/paris#about" className="links">
              <i className="fas fa-arrow-right"></i> About
            </Link>
            <Link to="/paris#destination" className="links">
              <i className="fas fa-arrow-right"></i> Điểm đến
            </Link>
            <Link to="/paris#services" className="links">
              <i className="fas fa-arrow-right"></i> Dịch vụ
            </Link>
            <Link to="/paris#gallery" className="links">
              <i className="fas fa-arrow-right"></i> Ảnh
            </Link>
            <Link to="/paris#blogs" className="links">
