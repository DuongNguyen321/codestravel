      ...
      <section className="footer">
        <div className="box-container">
          <div className="box">
            ...
            <div className="share">
              <Link to="/sydney" className="fab fa-facebook-f"></Link>
              <Link to="/sydney" className="fab fa-twitter"></Link>
              <Link to="/sydney"className="fab fa-instagram"></Link>
              <Link to="/sydney" className="fab fa-linkedin"></Link>
            </div>
          </div>
          <div className="box">
