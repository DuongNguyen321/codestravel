        ...
        <section className="footer">
          <div className="box-container">
            ...
            <div className="box">
              ...
              <Link to="/mumbai#about" className="links">
                <i className="fas fa-arrow-right"></i> About
              </Link>
              <Link to="/mumbai#destination" className="links">
                <i className="fas fa-arrow-right"></i> Điểm đến
              </Link>
              <Link to="/mumbai#services" className="links">
                <i className="fas fa-arrow-right"></i> Dịch vụ
              </Link>
              <Link to="/mumbai#gallery" className="links">
                <i className="fas fa-arrow-right"></i> Ảnh
              </Link>
              <Link to="/mumbai#blogs" className="links">
