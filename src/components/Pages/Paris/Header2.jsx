  ...
  return (
    <header className="header">
      ...
      <nav className="navbar">
        <Link to="/paris#home" data-aos="zoom-in-left" data-aos-delay="150">
          Home
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="200" to="/paris#about">
          About
        </Link>
        <Link
          data-aos="zoom-in-left"
        ...
        <Link data-aos="zoom-in-left" data-aos-delay="350" to="/paris#gallery">
          Ảnh
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="400" to="/paris#blogs">
          blogs
        </Link>
      </nav>
      <i
