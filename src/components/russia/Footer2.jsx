      ...
      <section className="footer">
        <div className="box-container">
          <div className="box">
            ...
            <div className="share">
              <Link to="/russia" className="fab fa-facebook-f"></Link>
              <Link to="/russia" className="fab fa-twitter"></Link>
              <Link to="/russia" className="fab fa-instagram"></Link>
              <Link to="/russia" className="fab fa-linkedin"></Link>
            </div>
          </div>
          <div className="box">
            ...
            <Link to="/russia#about" className="links">
              <i className="fas fa-arrow-right"></i> About
            </Link>
            <Link to="/russia#destination" className="links">
              <i className="fas fa-arrow-right"></i> Điểm đến
            </Link>
            <Link to="/russia#services" className="links">
              <i className="fas fa-arrow-right"></i> Dịch vụ
            </Link>
            <Link to="/russia#gallery" className="links">
              <i className="fas fa-arrow-right"></i> Ảnh
            </Link>
            <Link to="/russia#blogs" className="links">
