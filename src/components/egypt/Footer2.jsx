        ...
        <section className="footer">
          <div className="box-container">
            ...
            <div className="box">
              ...
              <Link to="/egypt#about" className="links">
                <i className="fas fa-arrow-right"></i> About
              </Link>
              <Link to="/egypt#destination" className="links">
                <i className="fas fa-arrow-right"></i> Điểm đến
              </Link>
              <Link to="/egypt#services" className="links">
                <i className="fas fa-arrow-right"></i> Dịch vụ
              </Link>
              <Link to="/egypt#gallery" className="links">
                <i className="fas fa-arrow-right"></i> Ảnh
              </Link>
              <Link to="/egypt#blogs" className="links">
