        ...
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                <Link to="/tokyo" className="fab fa-facebook-f"></Link>
                <Link to="/tokyo" className="fab fa-twitter"></Link>
                <Link to="/tokyo" className="fab fa-instagram"></Link>
                <Link to="/tokyo" className="fab fa-linkedin"></Link>
              </div>
            </div>
            <div className="box">
              ...
              <Link to="/tokyo#about" className="links">
                <i className="fas fa-arrow-right"></i> About
              </Link>
              <Link to="/tokyo#destination" className="links">
                <i className="fas fa-arrow-right"></i> Điểm đến
              </Link>
              <Link to="/tokyo#services" className="links">
                <i className="fas fa-arrow-right"></i> Dịch vụ
              </Link>
              <Link to="/tokyo#gallery" className="links">
                <i className="fas fa-arrow-right"></i> Ảnh
              </Link>
              <Link to="/tokyo#blogs" className="links">
