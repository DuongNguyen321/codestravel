        ...
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                <Link to="/china" className="fab fa-facebook-f"></Link>
                <Link to="/china" className="fab fa-twitter"></Link>
                <Link to="/china" className="fab fa-instagram"></Link>
                <Link to="/china" className="fab fa-linkedin"></Link>
              </div>
            </div>
            <div className="box">
              ...
              <Link to="/china#about" className="links">
                <i className="fas fa-arrow-right"></i> About
              </Link>
              <Link to="/china#destination" className="links">
                <i className="fas fa-arrow-right"></i> Điểm đến
              </Link>
              <Link to="/china#services" className="links">
                <i className="fas fa-arrow-right"></i> Dịch vụ
              </Link>
              <Link to="/china#gallery" className="links">
                <i className="fas fa-arrow-right"></i> Ảnh
              </Link>
              <Link to="/china#blogs" className="links">
